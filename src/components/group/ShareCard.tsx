...
export function ShareCard({
  ...
  return (
    <div
      className={`rounded-2xl overflow-hidden bg-surface-2 flex flex-col transition-transform duration-200 ${
        isTopPick ? "ring-4 ring-accent shadow-2xl shadow-accent/40 scale-[1.03]" : ""
      }`}
    >
